function ProfileCard({cardEmoji,cardHeader,cardSubtitle,cardBlurb,cardPic,cardBlurbt,cardHeadert,cardSubtitlet,cardPict,onClickLeft,onClickRight}) {
  
  
  return ( <>
    <div className="inline-block px-3 my-2 font-bold border-5 rounded-3xl shadow-md cursor-pointer hover:shadow-lg transition" onClick={onClickLeft}>
    ...
    </div><div className=" inline-block px-3 my-2 font-bold border-5 rounded-3xl shadow-md cursor-pointer hover:shadow-lg transition" onClick={onClickRight}>
